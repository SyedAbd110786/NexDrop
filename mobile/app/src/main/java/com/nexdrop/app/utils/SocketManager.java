...
public class SocketManager {
    ...
    public synchronized void connect(String serverUrl) {
        ...
        if (socket != null && socket.connected() && serverUrl.equals(currentServerUrl)) return;
    ...
    /** Join a pairing code generated by the PC */
    public void joinPairingCode(String sessionCode) {
        if (socket == null || sessionCode == null) return;
        try {
            JSONObject data = new JSONObject();
    ...
    public String getServerUrl() { return currentServerUrl != null ? currentServerUrl : BuildConfig.SERVER_URL; }
